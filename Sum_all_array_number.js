...
function sumAll(arr) {
  let max = Math.max(arr[0], arr[1]);//return maximum value with compare both argument
  let min = Math.min(arr[0], arr[1]);//return minimum value with compare both argument
  let sumBetween = 0;
